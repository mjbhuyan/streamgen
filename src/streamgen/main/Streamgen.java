...
/**
 * Entry point of the 'Streamgen' generation module.
 *
 * @generated
 */
public class Streamgen extends AbstractAcceleoGenerator {
    /**
     * The name of the module.
     *
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/streamgen/main/streamgen";
     ...
     * @generated
     */
    public static final String[] TEMPLATE_NAMES = { "streamgen" };
     ...
     * @generated
     */
    public Streamgen(URI modelURI, File targetFolder,
     ...
     * @generated
     */
    public Streamgen(EObject model, File targetFolder,
            List<? extends Object> arguments) throws IOException {
    ...
    public static void main(String[] args) {
        try {
            if (args.length < 2) {
                ...
                Streamgen generator = new Streamgen(modelURI, folder, arguments);
